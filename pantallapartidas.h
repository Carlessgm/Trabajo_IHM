...
private:
    ...
    void crearGraficoLineas(QList<QPair<int, int>> cantidad_gan, QList<QPair<int, int>> cantidad_per, int personas_dist); //Genera los gráficos de lineas de las partidas
