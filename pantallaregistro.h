...
private:
    ...
    bool validarEmail(const QString &email);  // Validar correo electrónico
    bool validarContrasenas();  // Validar que las contraseñas coincidan
    bool validarNombreUsuario(const QString &nombreUsuario); // Validar nombre de usuario
